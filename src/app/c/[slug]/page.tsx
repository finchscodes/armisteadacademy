...
export default async function CharacterProfilePage({
  ...
  const [levelProgress, yearLabel] = await Promise.all([
    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-ink-900 border border-ink-700 rounded-lg p-6">
        <div className="flex items-start gap-5">
          ...
          <span className="text-[10px] uppercase tracking-wider text-ink-400 border border-ink-600 rounded px-2 py-1 shrink-0">
