...
/**
 * A single comment thread for the whole phone conversation — you can't
 * reasonably comment on one text message out of a whole thread the way you
 * can a regular forum post, so this attaches to the topic as a whole
 * (technically stored against the opening post).
 */
export function PhoneCommentSection({
  postId,
  comments,
  canInteract,
  ...
  return (
    <div className="mt-8 border border-ink-700 rounded-lg overflow-hidden">
      <div className="px-4 py-3 border-b border-ink-700 bg-ink-900/60">
        <span className="text-sm font-medium text-parchment-100/80">
