...
CREATE UNIQUE INDEX "board_post_permissions_character_board_idx" ON "board_post_permissions" USING btree ("character_id","board_id");ALTER TABLE "boards" ADD COLUMN "extra_article_job" character_job;