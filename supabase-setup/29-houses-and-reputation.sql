-- Run this in Supabase's SQL Editor after 28-statuses-and-home-board.sql.
-- Adds the Houses/Halls system (Undercroft, Veil, Rampart, Eaves), the
-- sorting quiz tables, and the reputation ledger. Run
-- 30-hall-boards.sql right after this one, as its own separate query.
