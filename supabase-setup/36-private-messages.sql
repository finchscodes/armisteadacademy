-- Run this in Supabase's SQL Editor after 35-hall-welcome-and-topic-ooc-rating.sql.
-- Adds private messaging ("Owl Post") — separate from the in-character
-- Text Messages board. Threads can have multiple participants; only the
-- character who started the thread can add or remove people from it.
