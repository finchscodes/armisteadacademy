-- Run this in Supabase's SQL Editor. Replaces 92, which incorrectly
-- assumed the privacy_policy table already existed (it didn't — 83, which
-- creates it, was apparently never run). This creates the table if
-- missing and seeds it, safely — running this again later won't
